...
[![GoDoc](https://godoc.org/github.com/morya/go-dirtyfilter?status.svg)](https://godoc.org/github.com/morya/go-dirtyfilter)
...
``` bash
$ go get -v github.com/morya/go-dirtyfilter
```
...
import (
  ...
  "github.com/morya/go-dirtyfilter"
